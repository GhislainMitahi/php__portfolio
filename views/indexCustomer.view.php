...
<nav class=" or-navbar navbar fixed-top navbar-expand-lg navbar-dark  pof-navbar">
        <div class="container">
            ...
            <!-- <ul class="navbar-nav ms-auto">
                <li class="nav-item">
                    <a href="./signUp.view.php" class="btn btn-success">sign UP</a>
                </li>
            </ul> -->
        </div>
    </nav>
        ...
        <header class="container-fluid p-5 rounded border shadow">
         ...
         <div class="container">
             ...
             <div class="col form-floating mb-3">
                    ...
                    <div class="col-md-12">
                      <textarea name="message" id="" cols="140" rows="5" placeholder="Salut Ghisalin, ..."></textarea>
                      </div>
                    </div>
